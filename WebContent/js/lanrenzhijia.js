...
$('.ddw2').val(0);
setTimeout(function(){
$('.num').eq(0).find('p').stop().animate({'top':'10%'},500)
	},500);
...
setTimeout(function(){
$('.num').eq(0).find('p').animate({'top':'10%'},500);
	},1600);
	}else if(-b==1){
...
setTimeout(function(){
$('.num').eq(2).find('p').animate({'top':'40%'},500);
	},1600);
		}else if(-b==3){
$('.num').eq(2).find('p').animate({'top':'0'},500);
$('.num').eq(4).find('p').animate({'top':'0'},500);
setTimeout(function(){
$('.num').eq(3).find('p').animate({'top':'10%'},500);
	},1600);
		}
		else if(-b==4){
$('.num').eq(3).find('p').animate({'top':'0'},500);
...
$('.num').eq(4).find('p').animate({'top':'0'},500);
setTimeout(function(){
$('.num').eq(5).find('p').animate({'top':'20%'},500);
	},1600);
		}	
